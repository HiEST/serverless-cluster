...
LOCAL_VOL = 0
LOCAL_VOL_FULL = 1
LOCAL_VOL_FULL_MOPS = 1
LOCAL_VOL_RNOBUFF = 
LOCAL_VOL_WFLASH = 0
LOCAL_MEM_VOL = 0
REMOTE_NFS_VOL = 0
REMOTE_NFS_VOL_FULL = 0
REMOTE_NFS_VOL_FULL_SAMENODE = 1
REMOTE_NFS_VOL_FULL_MOPS = 0
...
def construct_out_file_name():
    ...
    if REMOTE_NFS_VOL and REMOTE_NFS_VOL_FULL and REMOTE_NFS_VOL_FULL_SAMENODE and REMOTE_NFS_VOL_RNOBUFF and REMOTE_NFS_VOL_FULL_MOPS:
...
if REMOTE_NFS_VOL_FULL_MOPS:
    print("REMOTE NFS VOL FULL MOPS:")
    # Compute read avgs
    print("FIRST BANDWIDTHS:")
